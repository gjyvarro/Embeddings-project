...
\begin{figure}[t]
    ...
    \caption{Threshold-based embedding of trees. The nodes $u_l, u$ and $u_r$ are at level $l$ while $u_1,u_2,u_3$ are at level $l+1$. \ch{Please note that this is only to give an intuitive idea of the proof construction. The exact shape of the circles and triangles will depend on the specific model of hyperbolic space used.}}
    \label{fig:trees}
\end{figure}
