...
Let us also mention that there is a concept of Gromov's hyperbolicity~\cite{gromov1987hyperbolic}, which is sometimes used to decide whether it is reasonable to embed a graph to a hyperbolic space. However, firstly, this estimator cannot be easily converted to curvature, and, secondly, it does not say anything about the embedding in spherical spaces.
